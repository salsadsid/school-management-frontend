    ...
    <section className="px-8 py-8 lg:py-16">
      <div className="container mx-auto text-center">
        ...
        <Typography className="mb-10 font-normal !text-lg lg:mb-20 mx-auto max-w-3xl !text-gray-500">
          Whether you have questions about admissions, need assistance with
          school activities, or have suggestions for improvement, our team is
          here to help.
        </Typography>
        <div className="grid grid-cols-1 gap-x-12 gap-y-6 lg:grid-cols-2 items-start">
          ...
          <form action="#" className="flex flex-col gap-4 lg:max-w-md">
            ...
            >
              Select Options for School Engagement
            </Typography>
